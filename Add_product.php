                    ...
                    <ul class="nav pcoded-inner-navbar sidenav-inner">
                        ...
                        <li class="nav-item pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li>
                                    <a href="dashboard-sale.html">Sales</a>
                                </li>
                            </ul>
                        </li>
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        ...
                                                        <span class="n-time text-muted">
                                                            <i class="icon feather icon-clock m-r-10"></i>5 min</span></p>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        ...
                                                        <span class="n-time text-muted">
                                                            <i class="icon feather icon-clock m-r-10"></i>10 min</span></p>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        ...
                                                        <span class="n-time text-muted">
                                                            <i class="icon feather icon-clock m-r-10"></i>12 min</span></p>
                                                    <p>currently login</p>
                                                </div>
                                            </div>
                                        </li>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p>
                                                        <strong>Joseph William</strong>
                                                        <span class="n-time text-muted">
                                                            <i class="icon feather icon-clock m-r-10"></i>30 min</span></p>
                                                    <p>Prchace New Theme and make payment</p>
                                                </div>
                                            </div>
                                        </li>
            ...
            <div class="tab-content" id="chatTabContent">
                            ...
                            <div class="main-friend-list">
                                ...
                                <div
                                    ...
                                    <a class="media-left" href="#!"><img
                                        ...
                                        alt="Generic placeholder image "></a>
                                    <div class="media-body">
                                        <p class="chat-header">Josephin Doe<small class="d-block">i am not what happened . .</small>
                                        </p>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <a class="media-left" href="#!"><img
                                        ...
                                        alt="Generic placeholder image"></a>
                                    <div class="media-body">
                                        <h6 class="chat-header">Lary Doe<small class="d-block">Avalable</small>
                                        </h6>
                                    </div>
                                </div>
                                <div
                                ...
                                <div
                                    ...
                                    <a class="media-left" href="#!">
                                        <div
                                            class="hei-50 wid-50 img-radius bg-success d-flex text-white f-22 align-items-center justify-content-center">A</div>
                                    </a>
                                    <div class="media-body">
                                ...
                                <div
                                    ...
                                    <a class="media-left" href="#!">
                                        <div
                                            class="hei-50 wid-50 bg-danger img-radius d-flex text-white f-22 align-items-center justify-content-center">JD</div>
                                    </a>
                                    <div class="media-body">
                                        <h6 class="chat-header">Josephin Doe<small class="d-block text-muted">Don't send me image</small>
                                        </h6>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <a class="media-left" href="#!"><img
                                        ...
                                        alt="Generic placeholder image"></a>
                                    <div class="media-body">
                                        <h6 class="chat-header">Lary Doe<small class="d-block text-muted">not send free msg</small>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                ...
                <div
                    ...
                    <div class="p-4 main-friend-cont scroll-div">
                        <h6 class="mt-2">
                            <i class="feather icon-monitor mr-2"></i>Desktop settings</h6>
                        <hr>
                        ...
                        <h6 class="mb-0 mt-5">
                            <i class="feather icon-layout mr-2"></i>Application settings</h6>
                        <hr>
                        <div class="form-group mb-0">
                            <div class="switch switch-primary d-inline m-r-10">
                        ...
                        <h6 class="mb-0 mt-5">
                            <i class="feather icon-globe mr-2"></i>System settings</h6>
                        <hr>
                        <div class="form-group mb-0">
                            <div class="switch switch-primary d-inline m-r-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form class="needs-validation" novalidate="" id="form-product">
                                                    <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                    <label for="validationCustom01">Product Name</label>
                                                    <input type="text" class="form-control"  placeholder="Product name" id="p_name" name="p_name" required="">
                                                    ...
                                                    <input type="text" class="form-control"  placeholder="Product code" id="p_code" name="p_code" required="">
                                                    <div class="valid-feedback">
                                                    ...
                                                    Please Enter Valid MRP Price.
                                                    </div>
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationCustom03">Selling Price </label>
                                                        <input type="number" class="form-control" id="sell" name="sell" placeholder="Selling Price" required="">
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <input type="file" class="form-control" id="p_image" name="p_image"  required="">
                                                    <div class="invalid-feedback">
                                                    ...
                                                    <p style="line-height: 70px; text-align: center;"> 
                                                        <button class="btn  btn-success sweet-success" type="submit" style="align-items: center;">Add Product</button></p>
                                                    </form>
                                                    <script>
...
<?php include_once 'model/msg.php'; ?>
        ...
        src="assets/images/browser/ie.png" alt=""> <div>IE (11 & above)</div> </a> </li>
        ...
        <script>
            (function () {
                ...
                try {
                    ...
                    window
                        .layoutHelpers
                        .setCollapsed(localStorage.getItem('layoutCollapsed') === 'true', false);
                } catch (e) {}
            })();
            $(function () {
            ...
            $(document).ready(function () {
                $("#pcoded").pcodedmenu(
                    {themelayout: 'horizontal', MenuTrigger: 'hover', SubMenuTrigger: 'hover'}
                );
            });
        </script>
